...
// FundX identity — baked as fallbacks so login works even if the NEXT_PUBLIC_*
// vars are unset on Vercel. APP_URL MUST be fundx (it becomes the SSO target the
...
const APP_URL    = process.env.NEXT_PUBLIC_APP_URL    ?? 'https://fundx.tecosystem.app';
const APP_NAME   = process.env.NEXT_PUBLIC_APP_NAME   ?? 'TEC FundX';
    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center', maxWidth: 420 }}>
        ...
        <div style={{ fontSize: 13, color: TEC_COLORS.subtext, marginBottom: 32, lineHeight: 1.6 }}>
          Governed collective capital on Pi. Sign in to explore verified investment pools.
        </div>
        <button
          onClick={handleLogin}
          disabled={isLoading}
